...
release = 'Automation Controller %s' % version
...
#html_title = None
html_title = 'OVERRIDE_ME'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
html_short_title = 'OVERRIDE_ME'
...
htmlhelp_basename = 'OVERRIDE_ME'

html_context = {
    'pubdateshort': pubdateshort,
...
html_uri = os.environ.get('URI', None)
intersphinx_mapping = dict()
pwd = os.path.dirname(os.path.realpath(__file__))
top_level = os.path.realpath(os.path.join(pwd, '../../'))
sys.path.append(top_level)
for docname in ('userguide', 'quickstart', 'controllerapi', 'administration', 'release-notes', 'upgrade-migration-guide'):
    #project_name = import_from('%s.source.conf' % docname, 'project')
    #project_name = project_name.replace(' ', '_')
    project_name = docname

    if html_uri:
        link_uri = html_uri + project_name + '/'
    else:
        link_uri = os.path.join(top_level, docname, 'build/html')
    intersphinx_mapping[docname] = (link_uri, 
                                    os.path.join(top_level, docname, 'build/html/objects.inv'))

# Automation Controller Installation and Reference Guide
