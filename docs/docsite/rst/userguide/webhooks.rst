...
1. Optionally generate a personal access token (PAT) for use with |at|.
	...
	.. image:: ../../common/source/images/webhooks-create-webhook-github-scope.png
...
2. Use the PAT to optionally create a GitHub credential:
	...
	.. image:: ../../common/source/images/webhooks-create-credential-github-PAT-token.png
	...
	.. image:: ../../common/source/images/webhooks-job-template-gh-webhook-credential.png

	| 

	d. Click **Save**. Now your job template is set up to be able to post back to GitHub. An example of one may look like this:

	.. image:: ../../common/source/images/webhooks-tower-to-github-status.png

.. _ug_webhooks_setup_github:

3. Go to a specific GitHub repo you want to configure webhooks and click **Settings**.

.. image:: ../../common/source/images/webhooks-github-repo-settings.png

4. Under Options, click **Webhooks**.

.. image:: ../../common/source/images/webhooks-github-repo-settings-options.png
...
6. To complete the Add Webhook page, you need to :ref:`enable webhooks in a job template <ug_jt_enable_webhooks>` (or in a :ref:`workflow job template <ug_wfjt_enable_webhooks>`), which will provide you with the following information:
	...
	d. Leave **Enable SSL verification** selected.
	 ...
	 .. image:: ../../common/source/images/webhooks-github-repo-add-webhook.png
	...
	.. image:: ../../common/source/images/webhooks-github-repo-choose-events.png

	f. Leave **Active** checked and click **Add Webhook**.

	 .. image:: ../../common/source/images/webhooks-github-repo-add-webhook-actve.png
...
.. image:: ../../common/source/images/webhooks-github-repo-webhooks-deliveries.png
...
1. Optionally, generate a personal access token (PAT). This token gives |at| the ability to post statuses back when we run jobs based on a webhook coming in. 
	...
	b. On the sidebar, under User Settings, click **Access Tokens**.
		...
		.. image:: ../../common/source/images/webhooks-create-webhook-gitlab-settings.png
	...
	.. image:: ../../common/source/images/webhooks-create-webhook-gitlab-scope.png
...
2. Use the PAT to optionally create a GitLab credential:
	...
	.. image:: ../../common/source/images/webhooks-create-credential-gitlab-PAT-token.png

	c. Go to the job template with which you want to enable webhooks, and select the webhook service and credential you created in the previous step.

	.. image:: ../../common/source/images/webhooks-job-template-gl-webhook-credential.png

	| 

	d. Click **Save**. Now your job template is set up to be able to post back to GitLab. An example of one may look like this:

	.. image:: ../../common/source/images/webhooks-tower-to-gitlab-status.png
...
.. image:: ../../common/source/images/webhooks-gitlab-repo-settings.png
...
.. image:: ../../common/source/images/webhooks-gitlab-repo-add-webhook.png
...
.. image:: ../../common/source/images/webhooks-jobs-extra-vars-payload.png

.. image:: ../../common/source/images/webhooks-jobs-extra-vars-payload-expanded.png
