...
All access that is granted to use, read, or write credentials is now handled through roles. You no longer set the “team” or “user” for a credential. Instead, you use |at|'s RBAC system to grant ownership, auditor, or usage roles.
...
| | Team “Use”          | | Engineers            | | This permission allows the ability for a user to the respective component within their job template.   |
+-----------------------+------------------------+----------------------------------------------------------------------------------------------------------+
